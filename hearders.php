...
<body x-data="{ isMenuOpen: false }" class="bg-gray-100">
    ...
    <header class="fixed top-0 left-0 right-0 z-50 bg-blue-600 text-white flutter-shadow h-16 flex items-center justify-between px-4">
        ...
        <!-- App Title -->
        <h1 class="text-lg font-bold">Driving School</h1>
    ...
    <div 
        ...
        class="side-menu fixed top-0 left-0 bottom-0 w-64 bg-white z-50 flutter-shadow p-4"
    >
    ...
    <script>
        // Additional JavaScript to handle body scroll and prevent background scroll when menu is open
        document.addEventListener('alpine:init', () => {
            Alpine.watch('isMenuOpen', (value) => {
                if (value) {
